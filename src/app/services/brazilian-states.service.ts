...
import { IBrazilianStatesService } from "../../domain/services/brazilian-states.interface";
import { CountryStateVO } from "../../domain/value-objects/country-state.vo";
import { Injectable } from "@angular/core";

@Injectable({providedIn: 'root'})
export class BrazilianStatesService implements IBrazilianStatesService {
  private readonly statesList: CountryStateVO[] = [
